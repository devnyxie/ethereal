...
export default function Home() {
  return (
    <>
      ...
      <div className="w-full relative flex items-center justify-center h-dvh mt-[-6.5rem]">
        <AnimatedBackground />
        <div className="w-[700px] flex justify-between items-center z-20">
          <div className="w-full flex flex-col md:flex-row items-center justify-between space-y-20 md:space-y-0">
            <div>
              <h1>{"Hi, I'm  Timothee 👋。"}</h1>
              <h3>
                {"A Passionate Full Stack"}{" "}
                <code className="testing">{"<Developer/>"}</code>
              </h3>
            </div>
            <Image
              src={pfp}
      ...
      {/* <div className="flex justify-center items-center">
        <>
          <div className="h-screen w-full overflow-hidden mt-40">
      ...
      {/* ------------------------------- */}
      {/* <div className="relative h-40 w-full overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#FFFFFF30,transparent_90%)] before:opacity-80 after:absolute  after:-left-1/2 after:bottom-1/2 after:aspect-[1/0.7] after:w-[200%] after:rounded-[0%] after:border-b after:border-[#7876c566] after:bg-zinc-900">
        <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#ffffff2c_1px,transparent_1px),linear-gradient(to_bottom,#3a3a3a01_1px,transparent_1px)] bg-[size:70px_80px] "></div>
      </div> */}
    </>
  );
